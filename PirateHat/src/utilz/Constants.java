...
public class Constants {
	...
	public static class ObjectConstants {
		...
		public static final int CHECKPOINT_WIDTH_DEFAULT = 32;
		public static final int CHECKPOINT_HEIGHT_DEFAULT = 48;
		public static final int CHECKPOINT_WIDTH = (int) (CHECKPOINT_WIDTH_DEFAULT * Game.SCALE);
		public static final int CHECKPOINT_HEIGHT = (int) (CHECKPOINT_HEIGHT_DEFAULT * Game.SCALE);
	...
	public static class EnemyConstants {
		...
		public static final int BALD_PIRATE = 4;
		public static final int CUCUMBER = 5;
		public static final int PIRATE_CAPTAIN = 6;
		...
		public static final int PIRATE_MOB_WIDTH = (int) (PIRATE_MOB_WIDTH_DEFAULT * Game.SCALE);
		public static final int PIRATE_MOB_HEIGHT = (int) (PIRATE_MOB_HEIGHT_DEFAULT * Game.SCALE);
		public static final int PIRATE_MOB_DRAWOFFSET_X = (int) (12 * Game.SCALE);
		public static final int PIRATE_MOB_DRAWOFFSET_Y = (int) (13 * Game.SCALE);
		...
		public static int GetSpriteAmount(int enemy_type, int enemy_state) {
			...
			case IDLE: {
				if (enemy_type == CRABBY)
					return 9;
				else if (enemy_type == PINKSTAR || enemy_type == SHARK || enemy_type == BOSS || IsPirateMob(enemy_type))
					return 8;
			}
			case RUNNING:
				return 6;
		...
		public static boolean IsPirateMob(int enemyType) {
			return enemyType == BALD_PIRATE || enemyType == CUCUMBER || enemyType == PIRATE_CAPTAIN;
		}
	}
