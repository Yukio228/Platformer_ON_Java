...
public class AudioPlayer {
	...
	private Clip getClip(String name) {
		...
		try {
			if (url != null)
				...
				audio = AudioSystem.getAudioInputStream(getAudioFile(name));
	...
	private File getAudioFile(String name) {
		...
		File[] candidates = { new File("res/audio", fileName), new File("PlatformerTutorial/res/audio", fileName), new File("../res/audio", fileName), new File("../../res/audio", fileName) };
